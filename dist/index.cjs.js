...
const TEXT_COLOR = {
    ...
    600: {
        ...
        gray: "text-gray-600 dark:text-gray-400 dark:hover:text-gray-400"
    },
    hover: {
...
const BUTTON_COLOR = {
    focus: {
        ...
        gray: "focus:ring-gray-500/50 focus:bg-gray-100/50"
    }
};
...
const Input = (e) => {
    ...
    const getClassName = React.useCallback(() => {
        ...
        const defaultInputClassName = `relative transition-all duration-300 py-2 pl-10 pr-14 w-full border-gray-200 dark:bg-slate-800 dark:text-white/80 dark:border-slate-600 rounded-lg tracking-wide font-light text-sm placeholder-gray-400 bg-white focus:ring disabled:opacity-40 disabled:cursor-not-allowed ${border} ${ring}`;
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("button", { className: "absolute left-0 h-full px-3 text-gray-400 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed z-10" },
            React__default["default"].createElement(ToggleButton, { isEmpty: true })),
        ...
        Object.values(period).filter(Boolean).length === 2 && (React__default["default"].createElement("button", { type: "button", ref: buttonRef, disabled: disabled, className: getToggleClassName() }, renderToggleIcon(false)))));
};
