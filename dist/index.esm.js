...
const Input = (e) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("button", { className: "absolute left-0 h-full px-3 text-gray-400 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed z-10" },
            React.createElement(ToggleButton, { isEmpty: true })),
        ...
        Object.values(period).filter(Boolean).length === 2 && (React.createElement("button", { type: "button", ref: buttonRef, disabled: disabled, className: getToggleClassName() }, renderToggleIcon(false)))));
};
